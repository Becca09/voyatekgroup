                                ...
                                <div>
                                    <div className='flex flex-row gap-12  border-b  mt-5 pb-5'>
                                        <div className='flex flex-row gap-2'>
                                            ...
                                            <div>
                                                ...
                                                <div className='flex flex-row gap-2 items-center justify-center'>
                                                    ...
                                                    <span className='font-extrabold text-primary-50 mb-3 '>.</span>
                                        ...
                                        <div className='flex flex-row gap-10'>
                                            <div className='flex flex-col gap-1'>
                                                <h1 className='text-center fonnt-bold text-2xl'>08:35</h1>
                                            ...
                                            <div>
                                                <div className='flex justify-between items-center'>
                                                    ...
                                                    <Icon id="flight-landing" className='h-6 w-6 ' />
                                                </div>
                                            ...
                                            <div className='flex flex-col gap-1'>
                                                <h1 className='text-center fonnt-bold text-2xl'>09:55</h1>
                                                <p className='text-primary-400 xs'>Sun, 20 Aug</p>
                                            </div>
                                        </div>

                                        <h1 className='mt-5 font-bold text-2xl'>N123,450.000</h1>
                                    ...
                                    <div className='text-primary-400 flex flex-row gap-3 border-b mt-5 pb-5'>
                                        ...
                                        <div className='flex flex-row iems-center'>
                                            ...
                                            <p className='text-xs mt-1'>Baggage:20kg, Cabin Baggage:8kg</p>
                                        </div>
                                        <div className='flex flex-row iems-center'>
                                            <Icon id="film" className='h-6 w-6 ' />
                                            <p className='text-xs mt-1'>in flight entertainment</p>
                                        </div>
                                        <div className='flex flex-row iems-center'>
                                            <Icon id="meal" className='h-6 w-6 ' />
                                            <p className='text-xs mt-1'>In flight meal</p>
                                        </div>
                                        <div className='flex flex-row iems-center'>
                                            <Icon id="usb" className='h-6 w-6 ' />
